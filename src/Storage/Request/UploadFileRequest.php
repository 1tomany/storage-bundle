...
final readonly class UploadFileRequest
{
    ...
    public static function public(string $filePath, string $remoteKey, ?string $contentType = null, ?string $customUrl = null): self
    {
        return new self($filePath, $remoteKey, $contentType, true, $customUrl);
    }

    public static function private(string $filePath, string $remoteKey, ?string $contentType = null, ?string $customUrl = null): self
    {
